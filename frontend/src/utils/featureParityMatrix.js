...
export const FEATURE_PARITY = [
  ...
  { key: 'fadeOut', label: 'Fade out (video opacity + audio gain)', panel: 'PropertiesPanel',
    preview: 'ok', clientExport: 'ok', serverExport: 'ok',
    notes: 'Same as fadeIn. On the per-segment-speed server path, clip-wide fades apply to the boundary segments in source time (matching that path’s video fades).' },
