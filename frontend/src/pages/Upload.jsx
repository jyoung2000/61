...
// Kept in sync with the backend offline-NMT language map
// (translator.SUPPORTED_LANGUAGES / nmt_translator._FLORES_CODES). Any of these
// can be picked as a subtitle target — translation is never capped to a short
// list. Ordered roughly by region for an easier scan.
const LANGUAGES = [
